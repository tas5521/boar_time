...
import 'package:boar_time/features/stamping/presentation/page/widgets/speech_bubble.dart';
...
class BoarSpeechArea extends HookWidget {
  BoarSpeechArea({super.key});

  final List<String> _freeMessages = [
    'どうも\n鯨偶蹄目イノシシ科の動物です',
  ...
  String get randomText {
    final list = [..._getMessagesByTime(), ..._freeMessages];
    final random = Random();
    return list[random.nextInt(list.length)];
  }

  List<String> _getMessagesByTime() {
