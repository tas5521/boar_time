...
//     return switch (data.first) {
//       ButcheringTimeState() => switch (format) {
//         ExportFormat.pdf => _exportPdfButchering(
//           headers: ["日付", "出勤", "退勤", "休憩", "累計"],
//           rows: _mapButcheringRows(data.cast<ButcheringTimeState>()),
//         ),
//         ExportFormat.csv => _exportButcheringCsv(
//           data.cast<ButcheringTimeState>(),
//         ),
//         ExportFormat.xlsx => _exportButcheringExcel(
//           data.cast<ButcheringTimeState>(),
//         ),
//       },
//       PatrolTimeState() => switch (format) {
//         ExportFormat.pdf => _exportPdfPatrol(
//           headers: [
//             "日付",
//             "開始",
//             "終了",
...
//         ),
//         ExportFormat.csv => _exportPatrolCsv(data.cast<PatrolTimeState>()),
//         ExportFormat.xlsx => _exportPatrolExcel(data.cast<PatrolTimeState>()),
//       },
//       _ => throw ArgumentError(
//         'ButcheringTimeState または PatrolTimeState のリストのみ出力できます。',
//       ),
//     };
//   }
...
//   }) async {
//     final bytes = await _export(format: format, data: data);
...
//   static Future<File> _saveAndOpen({
